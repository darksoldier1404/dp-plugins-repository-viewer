...
export const CommitIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M11 16.5l-3.5-3.5-3.5 3.5M11 1.5l3.5 3.5 3.5-3.5" />
        <path strokeLinecap="round" strokeLinejoin="round" d="M17.5 4.5v15M6.5 19.5v-15" />
    </svg>
);
